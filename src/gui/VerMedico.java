 ...
 * @author UNI
 */
public class VerMedico extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/1439253074_power_off.png"))); // NOI18N
...
// TODO add your handling code here:
    ...
    public void Modificar() {
        ...
        if (Fila >= 0) {
            ...
            ModificarMedico MM = new ModificarMedico(null, true);
            MM.CargarDatos(ID);
            MM.setVM(this);
            MM.setVisible(true);
...
//        ME.toFront();
    ...
    public void CargarDatos() {
        ...
        String[] Header = {"No.", "Nombres", "Apellidos", "Especialidad",
            "Estado"};
...
// TODO add your handling code here:
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (Fila >= 0) {
            ...
            int ID_Medico = Integer.parseInt(model.getValueAt(Fila, 0).
                toString());
...
// TODO add your handling code here:
    ...
    public void Buscar() {
        ...
        try {
            ...
            Conexion.runner().query(
                "Select * from MedicoV where Nombres like ? or Apellidos like ?",
                rs -> {
                List<String[]> r = new ArrayList<>();
