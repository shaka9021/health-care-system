...
– org.jvnet.substance.skin.SaharaSkin
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/1435362010_Login.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/1435355601_sign-error.png"))); // NOI18N
    ...
    public void Conectar() {
        ...
        if (!"".equals(User) || !"".equals(Pass)) {
            ...
            try {
                P = Conexion.runner().query(
                    "select ID_Usuario as ID_Usuario, Rol_Usuario as rol "
                    + "from Usuario "
                    + "where "
                    + "Nombre_Usuario = ? "
                    ...
                    principal.setRol(rs.getString("rol"));
            ...
            JOptionPane.showMessageDialog(this,
                ...
                "Ingrese", JOptionPane.ERROR_MESSAGE);
        }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InicioSesion dialog = new InicioSesion(new javax.swing.JFrame(),
                    true);
