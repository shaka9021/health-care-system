...
      Regenerado por el editor de formularios.
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/1435355686_pencil.png"))); // NOI18N
    ...
    public void Guardar() {
        ...
        if (fila < 0) {
            ...
            if (DiaDisponible()) {
                ...
                Cita.Agregar_Cita(Fecha, Hora, ID_Medico, ID_Paciente,
                    Dia_Semana, Semana);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        try {
            ...
            for (List<String> resultado : resultados) {
                ...
                cmbPaciente.addItem(iterator.next());
...
// TODO add your handling code here:
    ...
    private void cmbEspecialidadItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbEspecialidadItemStateChanged
        ...
        try {
            ...
            for (List<String> resultado : resultados) {
                Iterator<String> iterator = resultado.iterator();
                ID_Med[i] = Integer.parseInt(iterator.next());
                cmbMedico.addItem(iterator.next());
                i++;
            }
