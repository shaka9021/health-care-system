...
public class SeleccionarMes extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/1436141806_sign-check.png"))); // NOI18N
    ...
    public void Seleccionar(){
        ...
        if(Opcion==1){
        reporte = miDir.getAbsolutePath()+"/src/report/HorarioPorMedicoMensual.jasper";
        }
        else{
        reporte = miDir.getAbsolutePath()+"/src/report/HorarioMensualGeneral.jasper";
        }
